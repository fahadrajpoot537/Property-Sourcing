        ...
        <form action="{{ route('admin.investors.store') }}" method="POST">
                ...
                <div class="card-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="phone" class="form-control" value="{{ old('phone') }}" placeholder="+44 123 456 7890">
                        </div>
                        <div class="col-md-12">
                            <label class="form-label fw-bold">Location</label>
                            <input type="text" name="location" id="location" class="form-control" value="{{ old('location') }}" placeholder="Start typing the investor's location/address..." required>
                    ...
                    <div class="row g-4">
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="budget" class="form-control" value="{{ old('budget') }}" placeholder="e.g. 500000">
                            </div>
                        </div>
                        <div class="col-md-4 d-flex align-items-end">
                            <div class="form-check form-switch mb-2">
                                <input class="form-check-input" type="checkbox" name="is_cash_buy" id="is_cash_buy" value="1" {{ old('is_cash_buy') ? 'checked' : '' }}>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="bg-light p-3 rounded">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <p class="small text-muted">Commercial properties matching Rightmove standard classifications.</p>
                                        <!-- Add commercial types if needed -->
                                        <div class="form-check mb-2">
                                            <input class="form-check-input" type="checkbox" name="property_types[]" value="Commercial" id="pt_commercial">
                                            <label class="form-check-label" for="pt_commercial">General Commercial</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="row g-2">
                                <div class="col-6">
                                    ...
                                    <input type="number" name="min_bedrooms" class="form-control" placeholder="Any" value="{{ old('min_bedrooms') }}">
                                </div>
                                <div class="col-6">
                                    <label class="form-label fw-bold">Max Bedrooms</label>
                                    <input type="number" name="max_bedrooms" class="form-control" placeholder="Any" value="{{ old('max_bedrooms') }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="row g-2">
                                <div class="col-6">
                                    ...
                                    <input type="number" name="min_bathrooms" class="form-control" placeholder="Any" value="{{ old('min_bathrooms') }}">
                                </div>
                                <div class="col-6">
                                    <label class="form-label fw-bold">Max Bathrooms</label>
                                    <input type="number" name="max_bathrooms" class="form-control" placeholder="Any" value="{{ old('max_bathrooms') }}">
                                </div>
                            </div>
                        </div>
            ...
            <div class="content-card mb-4 shadow-sm border-0">
                <div class="card-body p-4 text-center">
                    ...
                    <div class="mt-3">
                        <p class="text-muted small mb-0">The system will automatically attempt to match this investor with existing and future listings.</p>
                    </div>
                </div>
            </div>
