...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Hi {{ $user->name }},</p>
            <p>Your account has been successfully created as a **{{ ucfirst($user->role) }}** at Property Sourcing Group. You can now log in to our platform to explore and manage your interests.</p>
