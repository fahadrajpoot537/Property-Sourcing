...
<body>
    <div class="container">
        <div class="header">
            <h2 style="margin: 0;">New Property Message</h2>
            <p style="margin: 10px 0 0; opacity: 0.9;">Property Sourcing Group</p>
        </div>
        <div class="content">
            <p style="font-size: 16px; margin-bottom: 25px;">You have received a new message regarding a property.</p>
            ...
            <div class="field">
                ...
                <div class="p-3 bg-light rounded italic">"{{ $message_text }}"</div>
            </div>

            <div style="text-align: center;">
                <a href="{{ $message_url }}" class="btn">Go to Messages</a>
            </div>
